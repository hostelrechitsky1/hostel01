...
export default function Dashboard() {
    ...
    const slotCapacity = useMemo(() => {
        ...
        const today = getBelarusDate();
        const weekStart = addBelarusDays(getBelarusWeekStart(today), 7);
        ...
        const bookedInTargetWeek = nextWeekBookings.filter(b => bookableDates.includes(b.date)).length;
    ...
    }, [machines, nextWeekBookings, settings.maintenanceDay, isNextWeekOpen]);
