...
import { Activity, Calendar, CheckCircle, Download, History, WashingMachine as Washer, XCircle } from 'lucide-react';
import type { AppSettings, Booking, Machine, Student } from '../types';
import { addBelarusMinutes, formatBelarusLongDateLabel, formatBelarusLongDateYearLabel, formatBelarusShortDateLabel, getBelarusNow, parseBelarusDateTime } from '../utils/time';
import { hapticSelection, hapticSuccess } from '../utils/haptics';
import { ActionSpinner } from './ActionSpinner';
import { getCancelBookingFailureMessage } from '../utils/bookingMutations';
import { getResidentPortalDateLocale } from '../utils/residentPortalLanguage';
import { getBookingDurationMinutes, getSlotDurationMinutes } from '../utils/slotSchedule';
...
export default function DashboardBookingSummary({
    ...
    const { upcomingBookings, history } = useMemo(() => {
        ...
        const upcoming = chronological.filter((booking) => (
            addBelarusMinutes(parseBelarusDateTime(booking.date, booking.startTime), getBookingDurationMinutes(booking, slotDurationMinutes)) > now
        ));
                        ...
                        <div className="booking-summary-actions">
                            <button
                                onClick={() => {
                                    ...
                                    const end = addBelarusMinutes(start, getBookingDurationMinutes(primaryUpcomingBooking, slotDurationMinutes));
                            ...
                            <button
                                onClick={async () => {
                                    ...
                                    const endDate = addBelarusMinutes(startDate, getBookingDurationMinutes(primaryUpcomingBooking, slotDurationMinutes));
                            ...
                            <>
                                ...
                                <div style={{ display: 'flex', gap: '10px', justifyContent: 'center' }}>
                                    <button
                                        ...
                                        className="glass-button cancel-keep-button"
                                    ...
                                    <button
                                        ...
                                        disabled={cancelBookingId === cancelModalBooking.id}
                                        className="glass-button cancel-booking-button cancel-booking-button--modal"
                                    >
